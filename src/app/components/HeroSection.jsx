      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="dark:text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            ...
            <br></br>
            <TypeAnimation
              sequence={["Rania", 1000, "Web Developer"]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
          ...
          <p className="text-gray-600 dark:text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Building modern web solutions that work, look, and feel amazing.
          </p>
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 dark:text-white"
            >
              Hire Me
            </Link>
